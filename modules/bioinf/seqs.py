...
from modules.bioinf.files import (
    check_funcs, file_types, load_funcs, plugins, write_funcs
)
...
# TODO: these classes need to be fixed
    ...
    def add_site(self, site, value='-'):
        ...
        for seq_cls in self:
            if isinstance(site, int):
                ...
                for pos in reversed(range(site.start, site.stop, site.step)):
