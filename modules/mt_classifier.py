...
def main_mt_hpred(contig_file = 'mtDNAassembly-contigs.fasta', muscle_exe = "/usr/bin/muscle", basename = "mtDNAassembly-contigs", best_results_file = 'mt_classification_best_results.csv', data_file = None):
    ...
    return seq_classify, contig_seq_diff, contig_mhcs_seq_diff, contig_rcrs_seq_diff, mergedtables
...
if __name__ == "__main__":
    ...
    sc, contig_seq_diff, contig_mhcs_seq_diff, contig_rcrs_seq_diff, mergedtables = main_mt_hpred(contig_file = contig_file, muscle_exe = muscle_exe, basename = basename, best_results_file = best_results_file, data_file = data_file)
    write_output(seq_classify, contig_seq_diff.diff_list, contig_mhcs_seq_diff.diff_list, contig_rcrs_seq_diff.diff_list, mergedtables, basename)
    # except:
